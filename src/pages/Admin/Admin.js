                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                                                <p>Set coupon code</p>
                                                <input type="text" name='coupon' placeholder='set coupon code ' />
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                                                <p>Discount</p>
                                                <input type="text" name='discount' placeholder='Set Discount ' />
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                        ...
                        <div className="col-md-6">
                                ...
                                <form onSubmit={refelhande}>
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                                                <p>Mobile</p>
                                                <input type="tel" name='phone' placeholder='set phone ' />
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                                        ...
                                        <div className="col-md-6">
                                            <div className="single-coupon">
                                                ...
                                                <input type="text" name='code' placeholder='Referee code' />
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                            <div className="single-coupon">
                            ...
                            <div className="coupon-user">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        {
                                            referee?.data?.map(copuoninfo => <tr key={copuoninfo._id}>

                                                <td>{copuoninfo?.name}</td>
                                                <td>{copuoninfo?.phone}</td>
                                                <td>{copuoninfo?.email}</td>
                                                <td>{copuoninfo?.code}</td>
                                                <td><button onClick={() => deleteProduct(copuoninfo)} className="btn btn-danger">Delete</button></td>
