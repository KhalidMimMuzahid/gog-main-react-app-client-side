...
import './Conditons.css'
const Conditons = () => {
    return (
        <div>
            <div className="conditon-area">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="conditions">
                                ...
                                <li>b) publish, post, upload, distribute or disseminate any
                                    improper, profane, defamatory, infringing, obscene, indecent, or
                                    unlawful topic, name, material, or information;</li>
                                <li>c) conduct or forward surveys, contests, pyramid schemes,</li>
                                <li>d) Falsifying or removing any author attributions, proper legal
                                    or other notices, or exclusive designations or labels of the
                                    source or origin of any software or other materials present in a
                                    file that is submitted;</li>
                                <li>e) Any information provided by You on this site shall not be
                                    misleading in any way.</li>
                                <li>f) Use any deep-link, robot, spider, or other automatic device,
                                    programme, algorithm, or methodology, or any comparable or
                                ...
                                <p>
                                    ...
                                    if a learner is not committed to their studies, a successful
                                    placement cannot occur. In our programme, a cutoff score of 70
                                    percent is currently used to determine placement connections. As
                                    we have observed numerous instances of back-to-back interview
                                    rejections without any offer for learners with less than a 70
                                    percent score, attending interviews will be pointless if
                                    standards are not met. To finally get placed, those students had
                                    to go through revision lessons. As a result of the extra time
                                    and effort required, we encourage all of our students to achieve
                                    this 70 percent on their first try.
                                </p><br />
                                <p>
                                    For freshmen or any professional, we aim to provide a minimum of
                                    3 lakhs.However, depending on the market, freshmen, learners who
                                    are presently unemployed, or freshmen who graduated from college
                                    but are still looking for work, may need to complete an initial
                                    internship process for 3-6 months before receiving the final
                                    package.
                                </p><br />
                                <p>
                                    Throughout the placement process, the Geeks of Gurukul team will
                                    be
                                    completely forthcoming regarding market conditions as well as
                                    applicant fit with the employer JD. Students should have the
                                    freedom to move forward with the process of constructing their
                                    career dreams by selecting the finest possibilities accessible
                                    at the time of graduation.
                                </p> <br />
                                <p>Candidate will be applicable for a refund only if</p><br />
                                <ul>
                                    <li>The candidate didn’t get any relevant career opportunity</li>
                                    <li>90 percent of the assignments were completed</li>
                                    <li>90 percent attendance.</li>
                                    <li>More than 70 percent in the course assessment</li>
                                    <li>Completed the whole Course</li>

                                </ul><br />
                                <h1>Copyright/Trademark Information</h1><br />
                                <p>Copyright ©. All rights reserved. All trademarks, logos and
                                    ...
                                    such third party which may own the Marks.</p><br />
                                <p>
                                    Contact us at support@geeksofgurukul.com for questions related
                                    to
